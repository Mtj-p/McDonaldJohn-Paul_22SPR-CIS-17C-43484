...
int main(int argc, char** argv) {
    ...
    int search=binSrch(array,SIZE,value);
     std::chrono::steady_clock::time_point end = std::chrono::steady_clock::now();
    cout<<"Total Time for Binary Search = "<<std::chrono::duration_cast<std::chrono::nanoseconds>(end-start).count()
            <<" nanoseconds with N = "<<SIZE<<endl;
