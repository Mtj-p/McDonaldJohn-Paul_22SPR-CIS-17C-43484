...
int main(int argc, char** argv) {
    ...
    int search=linSrch(array,SIZE,value);
    std::chrono::steady_clock::time_point end = std::chrono::steady_clock::now();
    cout<<"Total Time for Linear Search = "<<std::chrono::duration_cast<std::chrono::microseconds>(end-start).count()
            <<" microseconds with N = "<<SIZE<<endl;
