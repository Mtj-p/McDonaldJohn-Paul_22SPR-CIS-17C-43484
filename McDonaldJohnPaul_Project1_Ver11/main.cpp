...
int main(){
    ...
    */
    ...
    bool imfishin = false;
    int testnum=0;
    while(player1!=NULL&&deck.size()!=0){
        ...
        while(matches.size()!=0&&deck.size()!=0){
        //cout<<"matches=cmpHand success\n";
            ...
            while(player1!=NULL){
                //cout<<player1->card;
                //cout<<"\tmatches: "<<matches.size()<<" #"<<matches.front()<<" ";
                if(player1->card==matches.front()){
                    ...
                    if(deck.size()==0){
                        if(player1->nxtCard!=NULL){
                            temp2->nxtCard=player1->nxtCard;
                            delete player1;
                        }
                        if(player1->nxtCard==NULL){
                            delete player1;
...
void goFish(stack<int> &n,Hand *a){
    Hand *newhand=new Hand;
