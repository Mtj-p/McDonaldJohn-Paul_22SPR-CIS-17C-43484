/*
 * file: McDonaldJohnPaul_CodeE_SimpleVector
 * Author: John-Paul McDonald
 * Date: 03/22/22
 * Purpose: make push back, push front, pop
 *          front, pop back functions
 */
...
T SimpleVector<T>::popFrnt()
{
   ...
   T val = getElementAt(arraySize-arraySize);
   T *temp = aptr;
   try{
       aptr = new T [newSize];
   }
